...
4. 檔案路徑回傳給呼叫方，供下游 Agent 使用（如 `costaff-viz-report-agent`）
...
> 本 Agent **不負責**生成圖表、HTML 報告或 PDF。視覺化輸出由 [`costaff-viz-report-agent`](https://github.com/CoStaffAI/costaff-viz-report-agent) 負責。
