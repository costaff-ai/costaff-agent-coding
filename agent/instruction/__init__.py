...
Substitutes runtime placeholders ({WORKSPACE_DIR}, {COSTAFF_SHARED_DIR_CODING},
{user_id}, {PREFERRED_LANGUAGE}) with values from environment variables.
...
def build_instruction() -> str:
    ...
    shared_dir = os.getenv(
        "COSTAFF_SHARED_DIR_CODING",
        "/app/data/shared/costaff-agent-coding",
    )
